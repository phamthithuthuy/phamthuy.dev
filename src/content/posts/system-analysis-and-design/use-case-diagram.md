...
*   **Biến Use Case thành Sơ đồ quy trình (Flowchart):** Dùng nét đứt mũi tên nối các Use Case với nhau (Bấm Login -> Xem danh sách -> Chọn hàng). Sai hoàn toàn UML. Muốn vẽ thứ tự, hãy dùng [Activity Diagram](/posts/system-analysis-and-design/activity-diagram).
...
- Trích xuất luồng chi tiết: [Activity Diagram](/posts/system-analysis-and-design/activity-diagram)
- Xem tương tác kỹ thuật: [Sequence Diagram](/posts/system-analysis-and-design/sequence-diagram)
- Đóng gói vào tài liệu: [SRS và BRD](/posts/specification/srs-brd-for-ba)
