...
| Phân tích | cấu trúc hoá yêu cầu, phân rã chức năng, ưu tiên | FDD, MoSCoW, [Use Case](/posts/system-analysis-and-design/use-case-diagram) |
...
| Phát triển | làm rõ, trả lời câu hỏi dev, bảo vệ scope | Q&A, clarification, [story & AC](/posts/agile-delivery/user-story-and-acceptance-criteria) |
| Kiểm thử / UAT | hỗ trợ ca kiểm thử, nghiệm thu theo AC | tiêu chí nghiệm thu, hỗ trợ UAT |
| Vận hành / Thay đổi | phân tích yêu cầu thay đổi và ảnh hưởng | [Change Request & Impact](/posts/agile-delivery/change-request-and-impact-analysis) |
...
| Phân tích | chọn model cho từng câu hỏi: Use Case cho order flow, State Machine cho order status ("Pending Payment → Paid → Preparing → Shipped → Delivered") | [Use Case Diagram](/posts/system-analysis-and-design/use-case-diagram), domain model `SF-10` |
