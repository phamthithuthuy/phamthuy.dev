...
[[requirement-elicitation|Requirement Elicitation]] và
[[agile-concepts-for-ba|Agile Concepts]].
...
| 2. Phân loại | pain point | fact, requirement, business rule, assumption, open question | taxonomy (xem [[requirement-elicitation\|Requirement Elicitation §2]]) |
...
(xem [[user-story-and-acceptance-criteria\|User Story & AC §5]]).
...
**Bước 3: Viết story.** 8 User Story `SF-2..SF-9` (xem [[user-story-and-acceptance-criteria\|User Story & AC]]).
