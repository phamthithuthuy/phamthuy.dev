...
Quy tắc "luôn truy về why" được kiểm chứng ngay: mỗi story Solution (`SF-3`) đều truy được ngược tới mục tiêu Business (giảm bán quá stock) — nếu một yêu cầu không truy được tới "why", khả năng cao là nó chưa thuộc tầng Solution hợp lệ. Chi tiết từng tầng và cách viết BRD/SRS cho ShopFlow nằm ở [[srs-brd-for-ba|SRS và BRD cho BA]].
