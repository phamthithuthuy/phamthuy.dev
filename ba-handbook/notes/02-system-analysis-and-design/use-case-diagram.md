...
- chuẩn bị đầu vào để viết luồng sự kiện chi tiết hoặc [[user-story-and-acceptance-criteria|User Story và AC]]

Đọc kèm:

- [[fdd-vs-use-case|FDD vs Use Case: chọn cái nào]] — khi nào dùng FDD, khi nào dùng Use Case
- [[functional-decomposition-diagram|Functional Decomposition Diagram (FDD)]] — thường làm trước Use Case để dựng overview
- [[requirement-elicitation|Requirement Elicitation cho BA]] — nguồn đầu vào cho actor, mục tiêu, kịch bản
- [[shopflow-online-shop-case-study|ShopFlow Online Shop Case Study cho BA]] — case xuyên suốt cho ví dụ bên dưới
...
Khác với [[functional-decomposition-diagram|FDD]] (nhìn hệ thống ở mức cây tính năng tổng thể), Use Case đi sâu vào **một tính năng cụ thể** và làm rõ cách tính năng đó vận hành khi có người dùng tương tác.
...
4. **Cập nhật thường xuyên:** Use Case là **tài liệu sống**, cần cập nhật theo thay đổi của yêu cầu hoặc hệ thống — giống nguyên tắc tài liệu sống của [[functional-decomposition-diagram|FDD]].
...
- [[collections/modeling-and-flow/008 BA-37-UML-UC.pdf|UML Use Case sample]]
- [[collections/specification/008 FDD-1.pdf|FDD sample]]
...
- [[fdd-vs-use-case|FDD vs Use Case: chọn cái nào]]
- [[functional-decomposition-diagram|Functional Decomposition Diagram (FDD)]]
- [[user-story-and-acceptance-criteria|User Story và Acceptance Criteria cho BA]]
- [[requirement-elicitation|Requirement Elicitation cho BA]]
- [[shopflow-online-shop-case-study|ShopFlow Online Shop Case Study cho BA]]
