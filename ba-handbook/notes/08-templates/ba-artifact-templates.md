...
| Decision Log | Ghi trong mỗi buổi refinement (xem [[backlog-refinement\|Backlog Refinement]]) |
| Open Question Register | 3 open question từ workshop kick-off (xem [[requirements-workshop\|Requirements Workshop]]) |
